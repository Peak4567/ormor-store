            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white shadow-sm rounded-[20px] p-5">
                    <div class="flex justify-between items-center mb-4">
                        <div class="flex items-center space-x-3">
                            <div
                                class="bg-[#a7f3d0] w-10 h-10 rounded-full flex items-center justify-center text-[#059669]">
                ...
                <div class="bg-white shadow-sm rounded-[20px] p-5">
                    <div class="flex justify-between items-center mb-4">
                        <div class="flex items-center space-x-3">
                            <div
                                class="bg-[#fef08a] w-10 h-10 rounded-full flex items-center justify-center text-[#ca8a04]">
                ...
                <div class="bg-white shadow-sm rounded-[20px] p-5">
                    <div class="flex justify-between items-center mb-4">
                        <div class="flex items-center space-x-3">
                            <div
                                class="bg-[#fecdd3] w-10 h-10 rounded-full flex items-center justify-center text-[#e11d48]">
