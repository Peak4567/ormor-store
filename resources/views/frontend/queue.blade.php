...
@section('content')
    ...
    {{-- QUEUE ITEM --}}
    <section x-data="{ view: 'grid', tab: 'all', show: false, search: '' }" x-init="setTimeout(() => show = true, 50)" x-cloak class="max-w-screen-xl mx-auto w-full px-4 py-12">
            ...
            @forelse ($products->sortByDesc('success_bookings_count') as $product)
                <div x-show="show && ({{ $product->tabCondition }}) && (search === '' || '{{ strtolower($product->product_name) }}'.includes(search.toLowerCase()))"
                    ...
                    <div :class="view === 'list' ? 'lg:flex lg:items-center lg:gap-10 lg:flex-1' : ''">
                        ...
                        <div :class="view === 'list' ?
                            'lg:mb-0 lg:flex lg:items-center lg:gap-12 lg:flex-1 lg:w-full lg:justify-between' : 'mb-8'"
                            class="mb-8">
                            ...
                            <div :class="view === 'list' ? 'lg:mt-0 lg:flex lg:items-center lg:gap-8 lg:flex-1' : 'mt-3 relative'"
                                class="mt-3">
                    ...
                    <div class="mt-2">
                        @auth
                            ...
                            @elseif ($product->isOpenToday && $product->isWaitingForTime)
                                <button disabled
                                    class="w-full py-4 rounded-2xl bg-[#FFF8ED] text-orange-500 text-[15px] font-bold cursor-not-allowed border border-[#FFE8C4]">
                                    ยังไม่ถึงเวลาจอง
                                </button>
                            @else
                                <button disabled
                                    class="w-full py-4 rounded-2xl bg-slate-50 text-slate-400 text-[15px] font-bold cursor-not-allowed border border-slate-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-1">
                        ...
                        <p class="text-sm text-slate-400 mt-2">
                            วันที่เลือก: <span x-text="formatThaiDate(bookingDate)" class="font-medium">วันเสาร์ที่ 4
                                เมษายน
                                พ.ศ. 2569</span>
                        </p>
                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-3">
                            ...
                            <input type="text" readonly placeholder="ยังไม่ได้เลือกแพ็กเกจ"
